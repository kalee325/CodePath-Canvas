...
- Get random color of the tray if the user moves the position of the tray
- Get random color of a face if the user drags it out
- Remove a face by dragging it back to the tray
...
<img src='https://i.imgur.com/HZRTGRQ.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
